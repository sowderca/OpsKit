...
FunctionsToExport = 'New-Credential', 'Get-GoPrtgServer', 'Connect-GoPrtgServer', 
               'Set-GoPrtgAlias', 'Install-GoPrtgServer', 'Uninstall-GoPrtgServer'

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Copy-Device', 'Copy-Sensor', 'Copy-Group', 'Add-NotificationTrigger', 
               'Set-NotificationTrigger', 'Edit-NotificationTriggerProperty', 
               'Get-NotificationAction', 'Get-NotificationTriggerTypes', 
               'Get-NotificationTrigger', 'New-NotificationTriggerParameter', 
               'Remove-NotificationTrigger', 'Set-ObjectProperty', 'Confirm-Sensor', 
               'Get-Channel', 'Get-Group', 'Get-Probe', 'Get-ObjectProperty', 
               'Get-PrtgClient', 'Get-SensorTotals', 'Update-Object', 'Suspend-Object', 
               'Rename-Object', 'Resume-Object', 'Set-ChannelProperty', 
               'Remove-Object', 'Get-Device', 'Connect-PrtgServer', 
               'Disconnect-PrtgServer', 'Get-Sensor', 'New-SearchFilter', 
               'Move-Object', 'Set-ObjectPosition', 'Start-SortPrtgObject', 
               'Start-AutoDiscovery'
...
AliasesToExport = 'Add-Trigger', 'Edit-TriggerProperty', 'Get-Trigger', 
               'Get-TriggerTypes', 'New-TriggerParameter', 'Remove-Trigger', 
               'Set-Trigger', 'Set-ChannelSetting', 'Set-ObjectSetting', 
               'Acknowledge-Sensor', 'Pause-Object', 'Refresh-Object', 'Clone-Sensor', 
               'Clone-Group', 'Clone-Device', 'Sort-PrtgObject', 'Connect-GoPrtg', 
               'Install-GoPrtg', 'Uninstall-GoPrtg', 'GoPrtg'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '-Fixed a bug wherein Edit-NotificationTriggerProperty could not set values to $null
